...
<body class="">
    ...
    <div class="container">
        <div class="text-center" style="padding: 5rem 0;">
            ...
            <h1>KETUA DAN WAKIL BADAN EKSEKUTIF MAHASISWA</h1>
        </div>
        <div class="row mb-5">
            ...
            <div class="col-lg-4 mb-3">
                <div class="card shadow" style="width: 100%;">
                    <img src="{{ asset('uploads/bem/foto/'.$cadidate->foto) }}" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5>{{ $cadidate->nama }}</h5>
                        <p class="small text-black-50">Calon Ketua dan Wakil BEM nomor urut {{ $cadidate->nomor_urut }}.</p>
                        <div class="row">
                            <div class="col-6">
            ...
            <div class="modal fade" id="vote-{{ $cadidate->nomor_urut }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-sm">
                    <div class="modal-content">
                        ...
                        <form action="{{ url('vote/bem/'.$cadidate->nomor_urut) }}" method="post">
                            @csrf
